                ...
                <div className="form-body">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      ...
                      <div className="input-with-icon">
                        <HomeIcon size={18} className="input-icon" style={{ backgroundColor: '#fef3c7', color: '#d97706', padding: '4px', borderRadius: '4px', width: '28px', height: '28px', boxSizing: 'border-box' }} />
                        <select 
                          name="category" 
                          className="form-input"
